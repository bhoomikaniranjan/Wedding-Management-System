    ...
    <?php foreach ($booking as $bookWedding) : ?>
        ...
        <tr>
            ...
            <td>
                ...
                <!-- <a href="client_delete.php?booking=<?= $bookWedding->booking_id; ?>&user_id=<?= $bookWedding->user_id; ?>" class="btn btn-danger btn-sm active" data-toggle="tooltip" data-placement="top" title="Delete client "><i class="mdi mdi-delete"></i></a> -->
